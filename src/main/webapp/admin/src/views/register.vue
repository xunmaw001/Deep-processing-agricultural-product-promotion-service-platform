  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">深加工农产品推广服务平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiabianhao" class="input" type="text" placeholder="商家编号">
			   </div>
			 </div> -->
			<el-form-item label="商家编号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiabianhao" autocomplete="off" placeholder="商家编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.lianxidianhua) && `shangjia` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210316/1040aa7974bc46b7b6540a49a8380499.jpg");
		height: 100vh;
