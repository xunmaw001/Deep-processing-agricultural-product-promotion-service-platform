<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="检测报告" prop="jiancebaogao">
          <file-upload
          tip="点击上传检测报告"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiancebaogao" label="检测报告" prop="jiancebaogao">
            <el-button type="text" size="small" @click="download(ruleForm.jiancebaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmev19o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
