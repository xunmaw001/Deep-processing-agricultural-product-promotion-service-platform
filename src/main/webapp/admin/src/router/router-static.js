...
import center from '@/views/center'
    ...
    import diaochabaogao from '@/views/modules/diaochabaogao/list'
    ...
    import tuiyaxinxi from '@/views/modules/tuiyaxinxi/list'
    import yonghu from '@/views/modules/yonghu/list'
    import chat from '@/views/modules/chat/list'
    import shichixinxi from '@/views/modules/shichixinxi/list'
